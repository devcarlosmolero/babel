...
export default function SignInPage() {
    return (
        <Page className="flex h-screen items-center justify-center">
            <Form className="flex max-w-[500px] flex-col gap-y-8 rounded-lg border border-border bg-white/60 p-6 backdrop-blur md:p-10">
                <div className="flex items-center justify-center">
                    <img alt="Logo" className="w-[70px]" src="./logo.png" />
                </div>
                <div className="space-y-3 text-center">
                    <h1 className="font-primary text-5xl font-bold">Sign In</h1>
                    <p className="text-tertiary md:text-base">
                ...
                <Button className="w-full !py-3 !text-xl">Sign in</Button>
            </Form>
        </Page>
    )
}
